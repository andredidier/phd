...
\end{isamarkuptext}\isamarkuptrue%
%
\isamarkupsubsection{Basic \ac{algebra} operators and tempo1%
}
\isamarkuptrue%
...
\ a{\isadigit{8}}\ a{\isadigit{7}}\ a{\isadigit{6}}\ a{\isadigit{5}}\ a{\isadigit{4}}\ a{\isadigit{3}}\ a{\isadigit{2}}\ a{\isadigit{1}}\ local{\isachardot}compl{\isacharunderscore}inf\ local{\isachardot}compl{\isacharunderscore}sup\ local{\isachardot}not{\isacharunderscore}xbefore\ \isacommand{by}\isamarkupfalse%
\ presburger\isanewline
\ \ \isacommand{have}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{1}}{\isacharcolon}\ {\isachardoublequoteopen}sup\ {\isacharparenleft}{\isacharminus}\ a{\isacharparenright}\ {\isacharparenleft}{\isacharminus}\ a{\isacharparenright}\ {\isacharequal}\ {\isacharminus}\ a{\isachardoublequoteclose}\isanewline
\ \ \ \ \isacommand{by}\isamarkupfalse%
\ auto\isanewline
\ \ \isacommand{have}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{2}}{\isacharcolon}\ {\isachardoublequoteopen}{\isasymforall}f\ a\ aa{\isachardot}\ {\isasymnot}\ abel{\isacharunderscore}semigroup\ f\ {\isasymor}\ f\ {\isacharparenleft}a{\isacharcolon}{\isacharcolon}{\isacharprime}a{\isacharparenright}\ aa\ {\isacharequal}\ f\ aa\ a{\isachardoublequoteclose}\isanewline
\ \ \ \ \isacommand{by}\isamarkupfalse%
...
\ \ \ \ \isacommand{using}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{1}}\ local{\isachardot}inf{\isachardot}abel{\isacharunderscore}semigroup{\isacharunderscore}axioms\ \isacommand{by}\isamarkupfalse%
\ presburger\isanewline
\ \ \isacommand{have}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{4}}{\isacharcolon}\ {\isachardoublequoteopen}inf\ b\ {\isacharparenleft}xbefore\ b\ a{\isacharparenright}\ {\isacharequal}\ inf\ {\isacharparenleft}xbefore\ b\ a{\isacharparenright}\ b{\isachardoublequoteclose}\isanewline
\ \ \ \ \isacommand{using}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{2}}\ local{\isachardot}inf{\isachardot}abel{\isacharunderscore}semigroup{\isacharunderscore}axioms\ \isacommand{by}\isamarkupfalse%
\ blast\isanewline
\ \ \isacommand{have}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{5}}{\isacharcolon}\ {\isachardoublequoteopen}inf\ a\ {\isacharparenleft}xbefore\ b\ a{\isacharparenright}\ {\isacharequal}\ xbefore\ b\ a{\isachardoublequoteclose}\isanewline
\ \ \ \ \isacommand{using}\isamarkupfalse%
...
\ \ \isacommand{then}\isamarkupfalse%
\ \isacommand{have}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{6}}{\isacharcolon}\ {\isachardoublequoteopen}inf\ {\isacharparenleft}xbefore\ b\ a{\isacharparenright}\ a\ {\isacharequal}\ xbefore\ b\ a{\isachardoublequoteclose}\isanewline
\ \ \ \ \isacommand{using}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{2}}\ local{\isachardot}inf{\isachardot}abel{\isacharunderscore}semigroup{\isacharunderscore}axioms\ \isacommand{by}\isamarkupfalse%
\ presburger\isanewline
\ \ \isacommand{then}\isamarkupfalse%
...
\ \ \ \ \isacommand{using}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{4}}\ a{\isadigit{9}}\ a{\isadigit{8}}\ a{\isadigit{7}}\ a{\isadigit{6}}\ a{\isadigit{5}}\ a{\isadigit{4}}\ a{\isadigit{3}}\ a{\isadigit{2}}\ a{\isadigit{1}}\ \isacommand{by}\isamarkupfalse%
...
\ \ \isacommand{then}\isamarkupfalse%
\ \isacommand{have}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{7}}{\isacharcolon}\ {\isachardoublequoteopen}inf\ b\ {\isacharparenleft}xbefore\ b\ a{\isacharparenright}\ {\isacharequal}\ inf\ {\isacharparenleft}sup\ {\isacharparenleft}xbefore\ a\ b{\isacharparenright}\ a{\isacharparenright}\ {\isacharparenleft}xbefore\ b\ a{\isacharparenright}{\isachardoublequoteclose}\isanewline
\ \ \ \ \isacommand{using}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{5}}\ a{\isadigit{3}}\ a{\isadigit{2}}\ \isacommand{by}\isamarkupfalse%
\ {\isacharparenleft}simp\ add{\isacharcolon}\ local{\isachardot}inf{\isacharunderscore}sup{\isacharunderscore}distrib{\isadigit{1}}\ local{\isachardot}inf{\isacharunderscore}sup{\isacharunderscore}distrib{\isadigit{2}}\ local{\isachardot}xbefore{\isacharunderscore}inf{\isacharunderscore}equiv{\isacharunderscore}bot{\isacharparenright}\isanewline
\ \ \isacommand{have}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{8}}{\isacharcolon}\ {\isachardoublequoteopen}sup\ {\isacharparenleft}xbefore\ a\ b{\isacharparenright}\ a\ {\isacharequal}\ a{\isachardoublequoteclose}\isanewline
\ \ \ \ \isacommand{using}\isamarkupfalse%
\ a{\isadigit{9}}\ a{\isadigit{8}}\ a{\isadigit{7}}\ a{\isadigit{6}}\ a{\isadigit{5}}\ a{\isadigit{4}}\ a{\isadigit{3}}\ a{\isadigit{2}}\ a{\isadigit{1}}\ \isacommand{by}\isamarkupfalse%
\ {\isacharparenleft}metis\ {\isacharparenleft}no{\isacharunderscore}types{\isacharparenright}\ xbefore{\isacharunderscore}sup{\isacharunderscore}absorb{\isacharunderscore}{\isadigit{1}}{\isacharparenright}\isanewline
\ \ \isacommand{have}\isamarkupfalse%
...
\ \ \ \ \isacommand{by}\isamarkupfalse%
\ {\isacharparenleft}metis\ f{\isadigit{1}}{\isadigit{1}}\ f{\isadigit{1}}{\isadigit{3}}\ f{\isadigit{1}}{\isadigit{6}}\ local{\isachardot}compl{\isacharunderscore}inf{\isacharunderscore}bot\ local{\isachardot}inf{\isachardot}left{\isacharunderscore}commute\ local{\isachardot}inf{\isacharunderscore}bot{\isacharunderscore}right{\isacharparenright}\isanewline
\ \ \isacommand{then}\isamarkupfalse%
\ \isacommand{have}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{9}}{\isacharcolon}\ {\isachardoublequoteopen}inf\ {\isacharparenleft}sup\ {\isacharparenleft}{\isacharminus}\ a{\isacharparenright}\ {\isacharparenleft}{\isacharminus}\ {\isacharparenleft}{\isacharminus}\ b{\isacharparenright}{\isacharparenright}{\isacharparenright}\ {\isacharparenleft}xbefore\ b\ a{\isacharparenright}\ {\isacharequal}\ inf\ {\isacharparenleft}sup\ {\isacharparenleft}xbefore\ a\ b{\isacharparenright}\ a{\isacharparenright}\ {\isacharparenleft}xbefore\ b\ a{\isacharparenright}{\isachardoublequoteclose}\isanewline
\ \ \ \ \isacommand{using}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{7}}\ f{\isadigit{1}}{\isadigit{3}}\ \isacommand{by}\isamarkupfalse%
\ {\isacharparenleft}simp\ add{\isacharcolon}\ local{\isachardot}inf{\isacharunderscore}sup{\isacharunderscore}distrib{\isadigit{2}}{\isacharparenright}\isanewline
\ \ \isacommand{have}\isamarkupfalse%
...
\ \ \ \ \isacommand{using}\isamarkupfalse%
\ local{\isachardot}distrib{\isacharunderscore}imp{\isadigit{1}}\ local{\isachardot}inf{\isacharunderscore}sup{\isacharunderscore}distrib{\isadigit{1}}\ \isacommand{by}\isamarkupfalse%
\ force\isanewline
\ \ \isacommand{then}\isamarkupfalse%
\ \isacommand{have}\isamarkupfalse%
...
\ \ \ \ \isacommand{using}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{0}}\ f{\isadigit{1}}{\isadigit{5}}\ f{\isadigit{1}}{\isadigit{8}}\ f{\isadigit{1}}{\isadigit{9}}\ local{\isachardot}inf{\isacharunderscore}compl{\isacharunderscore}bot\ local{\isachardot}inf{\isacharunderscore}sup{\isacharunderscore}distrib{\isadigit{1}}\ local{\isachardot}sup{\isacharunderscore}commute\ \isacommand{by}\isamarkupfalse%
\ auto\isanewline
\ \ \isacommand{then}\isamarkupfalse%
\ \isacommand{show}\isamarkupfalse%
\ {\isacharquery}thesis\isanewline
\ \ \ \ \isacommand{using}\isamarkupfalse%
\ f{\isadigit{1}}{\isadigit{2}}\ \isacommand{by}\isamarkupfalse%
