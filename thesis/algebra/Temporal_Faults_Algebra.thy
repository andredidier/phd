...
class temporal_faults_algebra_basic = boolean_algebra +
  ...
  assumes xbefore_not_sym: "\<lbrakk>tempo1 a; tempo1 b\<rbrakk> \<Longrightarrow> (xbefore a b) \<le> -(xbefore b a)"
...
class temporal_faults_algebra_equivs = temporal_faults_algebra_assoc +
  ...
  assumes xbefore_inf_equiv_bot: "\<lbrakk>tempo1 a; tempo1 b\<rbrakk> \<Longrightarrow> inf (xbefore a b) (xbefore b a) = bot"
  assumes xbefore_sup_equiv_inf: "independent_events a b \<Longrightarrow> \<lbrakk>tempo1 a; tempo1 b\<rbrakk> \<Longrightarrow> 
...
class temporal_faults_algebra_trans = temporal_faults_algebra_equivs +
  assumes xbefore_trans: "\<lbrakk>tempo1 a; tempo1 b; tempo1 c\<rbrakk> \<Longrightarrow> \<lbrakk>tempo2 a; tempo2 b; tempo2 c\<rbrakk> \<Longrightarrow>
    less_eq (inf (xbefore a b) (xbefore b c)) (xbefore a c)"

class temporal_faults_algebra_mixed_ops = temporal_faults_algebra_trans +
  assumes xbefore_sup_1: "xbefore (sup a b) c = sup (xbefore a c) (xbefore b c)"
  assumes xbefore_sup_2: "xbefore a (sup b c) = sup (xbefore a b) (xbefore a c)"
  assumes xbefore_not: "
...
theorem xbefore_inf_1: 
  "independent_events a b \<Longrightarrow> \<lbrakk>tempo1 a; tempo1 b\<rbrakk> \<Longrightarrow> \<lbrakk>tempo2 a; tempo2 b\<rbrakk> \<Longrightarrow> 
  \<lbrakk>tempo3 a; tempo3 b\<rbrakk> \<Longrightarrow> \<lbrakk>tempo4 a; tempo4 b\<rbrakk> \<Longrightarrow> 
  xbefore (inf a b) c = sup (xbefore (xbefore a b) c) (xbefore (xbefore b a) c)"
proof-
  assume "independent_events a b" "tempo1 a" "tempo1 b" "tempo2 a" "tempo2 b" "tempo3 a" "tempo3 b"
  "tempo4 a" "tempo4 b"
...
theorem xbefore_inf_2: 
  "independent_events b c \<Longrightarrow> \<lbrakk>tempo1 b; tempo1 c\<rbrakk> \<Longrightarrow> \<lbrakk>tempo2 b; tempo2 c\<rbrakk> \<Longrightarrow> 
  \<lbrakk>tempo3 b; tempo3 c\<rbrakk> \<Longrightarrow> \<lbrakk>tempo4 b; tempo4 c\<rbrakk> \<Longrightarrow> 
  xbefore a (inf b c) = sup (xbefore a (xbefore b c)) (xbefore a (xbefore c b))"
proof-
  assume "independent_events b c" "tempo1 b" "tempo1 c" "tempo2 b" "tempo2 c" "tempo3 b" "tempo3 c"
  "tempo4 b" "tempo4 c"
...
lemma xbefore_sup_absorb_1b: "independent_events a b \<Longrightarrow> \<lbrakk>tempo1 a; tempo1 b\<rbrakk> \<Longrightarrow> 
    \<lbrakk>tempo2 a; tempo2 b\<rbrakk> \<Longrightarrow> \<lbrakk>tempo3 a; tempo3 b\<rbrakk> \<Longrightarrow> \<lbrakk>tempo4 a; tempo4 b\<rbrakk> \<Longrightarrow>
    sup (xbefore b a) a = a"
by (metis inf_le1 order_trans sup.absorb2 sup.cobounded2 xbefore_sup_equiv_inf)

lemma xbefore_sup_absorb_2: "independent_events a b \<Longrightarrow> \<lbrakk>tempo1 a; tempo1 b\<rbrakk> \<Longrightarrow> 
    \<lbrakk>tempo2 a; tempo2 b\<rbrakk> \<Longrightarrow> \<lbrakk>tempo3 a; tempo3 b\<rbrakk> \<Longrightarrow> \<lbrakk>tempo4 a; tempo4 b\<rbrakk> \<Longrightarrow>
    sup a (xbefore a b) = a"
by (metis dual_order.trans inf.cobounded1 sup.absorb1 sup.cobounded1 xbefore_sup_equiv_inf)

corollary xbefore_sup_absorb_1: "independent_events a b \<Longrightarrow> \<lbrakk>tempo1 a; tempo1 b\<rbrakk> \<Longrightarrow> 
    \<lbrakk>tempo2 a; tempo2 b\<rbrakk> \<Longrightarrow> \<lbrakk>tempo3 a; tempo3 b\<rbrakk> \<Longrightarrow> \<lbrakk>tempo4 a; tempo4 b\<rbrakk> \<Longrightarrow>
    sup (xbefore a b) a = a"
proof-
  assume 0: "independent_events a b" "tempo1 a" "tempo1 b" "tempo2 a" "tempo2 b" "tempo3 a" 
    "tempo3 b" "tempo4 a" "tempo4 b"
  hence "sup a (xbefore a b) = sup (xbefore a b) a" by (simp add: sup.commute)
  thus ?thesis using 0 by (simp add: xbefore_sup_absorb_2)
qed

corollary xbefore_sup_absorb_2b: "independent_events a b \<Longrightarrow> \<lbrakk>tempo1 a; tempo1 b\<rbrakk> \<Longrightarrow> 
    \<lbrakk>tempo2 a; tempo2 b\<rbrakk> \<Longrightarrow> \<lbrakk>tempo3 a; tempo3 b\<rbrakk> \<Longrightarrow> \<lbrakk>tempo4 a; tempo4 b\<rbrakk> \<Longrightarrow>
    sup a (xbefore b a) = a"
proof-
  assume 0: "independent_events a b" "tempo1 a" "tempo1 b" "tempo2 a" "tempo2 b" "tempo3 a" 
    "tempo3 b" "tempo4 a" "tempo4 b"
  hence "sup a (xbefore b a) = sup (xbefore b a) a" by (simp add: sup.commute)
...
corollary inf_xbefore_equiv_sups_xbefore_expanded: 
  ...
  \<lbrakk>tempo1 a; tempo1 b; tempo1 c\<rbrakk> \<Longrightarrow> \<lbrakk>tempo2 a; tempo2 b; tempo2 c\<rbrakk> \<Longrightarrow> 
  \<lbrakk>tempo3 a; tempo3 b; tempo3 c\<rbrakk> \<Longrightarrow> \<lbrakk>tempo4 a; tempo4 b; tempo4 c\<rbrakk> \<Longrightarrow> inf a (xbefore b c) = 
...
proof-
  ...
  hence "inf a (xbefore b c) = sup (xbefore (inf a b) c) (xbefore b (inf a c))"
    "xbefore (inf a b) c = sup (xbefore (xbefore a b) c) (xbefore (xbefore b a) c)"
    "xbefore b (inf a c) = sup (xbefore (xbefore b a) c) (xbefore (xbefore b c) a)"
    by (auto simp add: inf_xbefore_equiv_sups_xbefore xbefore_inf_1 xbefore_inf_2 xbefore_assoc)
...
proof -
  ...
  hence "sup (inf a (- b)) (xbefore a b) = inf a (sup (inf a (- b)) (- xbefore b a))"
    using f10 by (metis (no_types) local.compl_sup local.double_compl local.sup_inf_distrib1)
  hence f12: "sup (inf a (- b)) (xbefore a b) = sup (inf a (- xbefore b a)) (inf a (- b))"
    using f11 by (simp add: local.sup.commute)
  have f13: "sup (xbefore a b) (xbefore b a) = inf a b"
    using a9 a8 a7 a6 a5 a4 a3 a2 a1 by (metis (no_types) local.xbefore_sup_equiv_inf)
  ...
  hence "sup (inf a (- xbefore b a)) (inf a b) = sup (inf a (- xbefore b a)) a"
    using local.sup.commute by auto
  hence "sup (inf a (- b)) (xbefore a b) = sup (inf a (- xbefore b a)) (inf (- b) (inf a b))"
