...
\DeclareAcronym{PAND}{%
	...
	long=priority-AND,
	class=gate,
	extra={Used in \acs*{SFT}, \acs*{TFT}, and \acs*{DFT}. Its text-only symbol is $<$.}
}
...
\DeclareAcronym{SAND}{%
	...
	class=gate,
	extra={Used in \acs*{TFT}. Its text-only symbol is $\&$.}
}
...
\DeclareAcronym{AFP}{%
	...
	long-post={\footnote{Accessed 24/apr/2017: \url{https://www.isa-afp.org}}}
}
\DeclareAcronym{MCS}{%
	short=MCS,
...
\DeclareAcronym{ANAC}{
	short = {ANAC}, 
	long = {Agência Nacional de Aviação Civil}
}

\DeclareAcronym{EASA}{
	short = {EASA}, 
	long = {European Aviation Safety Agency}
}
