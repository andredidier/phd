...
In this \lcnamecref{sec:qualitative-quantitative-analyses} we show how to formalize two kinds of properties\todo{MCSeq e a Probabilidade não seriam propriedades mas sim definições suas, não?! (FROM ACM)} of \acp{FT}: 
\begin{alineasinline}
