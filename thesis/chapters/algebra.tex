...
The set of sets for \acp{FBA}\index{Boolean Algebra!Free} is the basis of our proposed denotational semantics for Boolean\index{Boolean Algebra} algebras.
...
\end{equation}
%
where $L = \max{\left(0,i\right)}$ and $U = \min{\left(j,\length{xs}\right)}$.
...
Lastly, the \ac{XBefore} is transitive with preconditions over the intermediate variable.
