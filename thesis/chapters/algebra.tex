...
\begin{subequations}
\begin{align}
\formulaprob{\vari{1} \land \vari{2}} = & \Fit{1} \times \Fit{2}\label{eq:and-probability}\\
...
To enable the formal verification of structure expressions we use the concept of \emph{acceptance criteria}.\todo{ACM: colocar a sentença anterior em termos mais gerais de uma análise de FTA...}
