...
The elements of the has an implicit order number, but it is different from the Sequence Number function used in~\cite{WP2009,Walker2009}, but is related to the concept that there should be no gaps of the indexes between consecutive events occurrence.
...
%%%%%%%%%%%%%
\generators_{xs} = & \generators\left(\UNIV\right) - \listset{xs}\label{eq:generators-minus-list}
%%%%%
