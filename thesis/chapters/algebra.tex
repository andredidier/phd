...
In this \lcnamecref{sec:qualitative-quantitative-analyses} we show how to formalize two kinds of properties\todo{MCSeq e a Probabilidade não seriam propriedades mas sim definições suas, não?! (FROM ACM)} of \acp{FT}: (i) \ac{MCSeq}, the number of fault elements in the minimal sequences that cause a root failure, and (ii) the root probability, given the availability of basic fault occurrences probabilities.
...
For the two properties shown in this \lcnamecref{sec:qualitative-quantitative-analyses}, we define the two acceptance criteria:
%
\begin{subequations}
\begin{align}
