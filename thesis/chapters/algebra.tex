...
To show equivalence of a formula and its denotational we need two mapping functions: one that takes a formula e returns its set of distinct lists, and another that takes a set of distinct lists and returns a formula.
