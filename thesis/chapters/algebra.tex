...
The instantiation of the type class maps each syntactical element to a set of \distinctlists, including the operators of Boolean algebra and the \ac{XBefore} operator.
Such an instantiation imposes proof obligations for the type (the set of \distinctlists).
...
After mapping all axioms to the denotational semantics and proving them, the instance inherits the theorems of \ac{algebra}.
...
%%%TODO { [a,b]}_{a,b} = a -> b ||| { [a,b] }_{a,b,c} = not c and (a -> b)
\end{proof}
