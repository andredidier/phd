...
For example, the following formula can be proved using term rewriting:
%
\begin{align*}
& \tempo{S} \land \tempo{T} \land \independentevents{S}{T} \implies\nonumber\\
%%%%%
& \xbefore{S}{T} \lor \xbefore{T}{S} \lor \lnot \left(S \land T\right)\nonumber\\
%%%%%
= & \left(S \land T\right) \lor \lnot \left(S \land T \right) & \text{by \cref{thm:xbefore-sup-equiv-inf}}\nonumber\\
%%%%%
