...
Although Isabelle/HOL type class structure is able to syntactically reduce a formula, we need to create an explicit function for syntactical reduction to prove the soundness theorem.
...
The completeness theorem states if the semantics of a formula is equivalent to the semantics of $\top$, then it syntactically reduces to $\top$:
\begin{equation}
\forall~ f ~\bullet~ \semantically{f}{\top} \implies \syntactically{f}{top}
\end{equation}
