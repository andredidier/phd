...
The \acl{activation} proposed in this work emerges from the need to analyse the behaviour of a system when a subset of the faults have been triggered in some order, and to provide completeness analysis of system behaviour.
%
...
The predicates notation function returns a predicate in the algebra.
...
Non-determinism can also be checked using the predicates notation and the activation property:
\begin{subequations}
\begin{align}
