...
Using \cref{eq:formula-probability}, and for generators $f_1$ and $f_2$, we demonstrate the equivalence to \cref{eq:or-probability} (the probability of \iac{OR} operator), calculated using the denotational semantics:
%
\begin{align}
S = & \vari{1} \lor \vari{2}\nonumber\\
%%%
...
Also, it is possible to verify non-determinism on the model, by: (i) verifying its existence with the $\nondetcmd$ function, (ii) providing an expression and obtaining the possible operational modes with the $\activationcmd$ function, or (iii) using the predicates notation to obtain a predicate that enables two or more operational modes.
...
Boolean formulas reduction can be achieved by: (i) application of Boolean laws, (ii) \acp{BDD}, or (iii) \acp{FBA}.
...
%  We would like to thank \textbf{Alexander Romanovsky}, \textbf{Zoe Andrews} and \textbf{Richard Payne} for all discussions about fault modelling and dependability.
  %
  %We also thank the anonymous referees of the Journal \textbf{Advances in Intelligent Systems and Computing} for comments in drafts of this work.
  %
  This work was funded by CNPq, grants 476821/2011-8, 442859/2014-7, and 246956/2012-7, and
  %
