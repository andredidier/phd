...
The work reported in~\cite{ADH2003} shows how to calculate the probability of \iac{PAND} gate:
\begin{align}
P\left(t\right) & = \probabilityt{T_1 \le T_2 }\nonumber\\
& = \int_{x_1 = 0}^t P'_1\left(x_1\right)\left[P_2\left(t\right) - P_2\left(x_1\right)\right]d x_1\label{eq:pand-probability}
\end{align}
%
