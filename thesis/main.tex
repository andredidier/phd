...
The \ac{NOT} operator when combined with any other (\ac{AND}, \ac{OR}, and \ac{XBefore}) results on a nearly safe approximation to $1$:
\begin{align*}
...
\probabilityt{\xbefore{\lnot a}{b}} &\approx \probabilityt{b} \text{(see \cref{eq:pand-probability})}
\end{align*}
