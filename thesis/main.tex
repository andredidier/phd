...
\caption{\Ac{TTT} of \acsg*{TFT} operators and sequence value numbers}
...
We show dependency trees in~\cref{sec:dependency-trees}.
...
\begin{table}[t]
  ...
  \centering
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill} } p{5cm} p{5cm} p{5cm} }
...
\todo{Continue from here. Jump FBA.}
