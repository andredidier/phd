...
The use of the NOT is essential: besides its use in expressions, we use the complement to normalise the expressions to provide \emph{healthy} expressions.
...
Further in \cref{chap:strategy} we abstract these differences and leave the distinction as a parameter.
