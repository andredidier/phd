...
We explain how these methods interact in \cref{sec:strategy}.
...
The works reported in~\cite{AFP+2013,APR+2013} define several \ac{SysML} structural and behavioural views to model the fault-error-failure chain and fault tolerance.
...
The works map \ac{SysML} to \ac{CML} and \ac{CSP}, respectively, to verify fault tolerance.
...
This work attains to \acp{DFT} and we detail them in \cref{sec:dynamic-fault-trees}.
