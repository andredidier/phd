...
The gas detection system\index{gas detection system} depicted in \cref{fig:gas-detection-system} has two sensors $D_1$ and $D_2$ used to detect a leakage in a confined space.
...
The minimal cut sets obtained from this will be: $R_1 \land R_2$, $D_1 \land D_2$, and $LU$.
