...
\begin{figure}[t]
  ...
  \label{fig:sft-gates}
  \todo{Colocar figuras das portas de SFT.}
\end{figure}
...
\Aclp{TFT} are \ldots...
\todo{talk about minimal cut sequences}
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.15\linewidth}
    \centering
    \includegraphicsaspectratio[1]{ft-symbol-pand-gate}
    \caption{\pandtext gate}\label{fig:tft-pand-gate}
  \end{subfigure}
  \begin{subfigure}[b]{0.15\linewidth}
    \centering
    \includegraphicsaspectratio[1]{ft-symbol-por-gate}
    \caption{\portext gate}\label{fig:tft-por-gate}
  \end{subfigure}
  \begin{subfigure}[b]{0.15\linewidth}
    \centering
    \includegraphicsaspectratio[1]{ft-symbol-sand-gate}
...
\begin{figure}[t]
  ...
  \todo{Colocar figuras das portas de DFT.}
\end{figure}
...
The \ibeforetext is a composition of the \nibeforetext and the \simultaneoustext operators.
Structure expressions\index{structure expression} are reduced to a normal form (similar to \ac{DNF}) using algebraic laws, as for example:
\begin{subequations}
\begin{align}
%a \lor \parsin{a \nibefore b} &= a\\
