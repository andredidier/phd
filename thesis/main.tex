\documentclass[12pt,oneside,a4paper,oldfontcommands,english,brazil,final,sumario=abnt-6027-2012]{abntex2}
%\documentclass[12pt,openright,oneside,a4paper,english,brazil,final]{abntex2}
...
\def\undefinednominal{\ensuremath\mathit{undefined}}
...
\def\VAL{\ensuremath\mathit{VAL}}
\newcommand{\normalform}[1]{\ensuremath{\mathrm{reduce}~#1}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\makeindex

%\includeonly{chapters/case-study}
...
\includepdf[pages={1}]{ficha-aprovacao.pdf}
...
The former with the trip to Newcastle upon Tyne with the Sandwich Doctorate scholarship in Newcastle upon Tyne, grant 246956/2012-7, and the latter during the time I stayed in Recife, before and after the trip, with Doctorate scholarship, grant IBPG-0408-1.03/11.
...
%\begin{keywords}
\textbf{Keywords}: Fault Tree Analysis. Temporal Fault Trees. Dynamic Fault Trees. Isabelle/HOL. 
%\end{keywords},
\end{resumo}
...
\vspace{\onelineskip}
\noindent
\textbf{Palavras-chave}: Análise de Árvore de Falhas. Árvores de Falhas Temporais. Árvore de Falhas Dinâmicas. Isabelle/HOL. 
\end{otherlanguage*}
\end{resumo}
