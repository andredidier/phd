...
Joining the paths described in \cref{fig:strategy-overview-traditional,fig:strategy-overview-csp,fig:strategy-overview-activation}, the complete proposed solution is summarized in \cref{fig:strategy-overview}.
%
\begin{figure}[htb]
  \centering
