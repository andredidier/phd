...
%
\begin{align}
\probability{\lnot \var{f_1}} = & \denotationalprob{\left[\right]} + \denotationalprob{\left[f_2\right]} & \text{by \cref{eq:algebra-probability}} \nonumber\\
%%%%%%%%%%%%%
...
%%%%
=&\denotationalprob{\left[f_1,f_2\right]} + \denotationalprob{\left[f_2,f_1\right]} & \text{by \cref{eq:algebra-probability}} \nonumber\\
%%%%
...
S &= \vari{1} \lor \vari{2}\nonumber\\
%%%
\probability{S} = & \denotationalprob{\left[f_1\right]} +
