...
\def\nibeforetext{non-inclusive-before (ni-before, $\nibefore$)%
  \gdef\nibeforetext{NI-Before\xspace}%
  \xspace
}
\def\ibeforetext{inclusive-before (i-before, $\ibefore$)%
...
\begin{figure}[t]
\includegraphicsaspectratio[1]{sft-symbols-ft-handbook}
...
\begin{figure}[t]
  ...
  \subcaptionbox{Transfer symbol\label{fig:sft-transfer}}
    [.25\textwidth]{%
      \includegraphics{ft-symbol-transfer}
    }
...
The work reported in~\cite{Merle2010,MRL+2010,MRL2011} describe an algebra with operators \ortext and \andtext, and three new operators to express events ordering: (i) \nibeforetext, (ii) \simultaneoustext, and (iii) \ibeforetext.
The non-inclusive-before and the simultaneous operators are similar to \ac{TFT}'s \portext and \sandtext operators, respectively.
...
\begin{figure}[t]
  \centering
  \subcaptionbox{\andtext gate\label{fig:tft-pand-gate}}
    [.25\textwidth]{%
      \includegraphics{ft-symbol-pand-gate}
    }
  \subcaptionbox{\ortext gate\label{fig:tft-por-gate}}
    [.25\textwidth]{%
      \includegraphics{ft-symbol-por-gate}
    }
  \subcaptionbox{\nottext gate\label{fig:tft-sand-gate}}
    [.25\textwidth]{%
      \includegraphics{ft-symbol-sand-gate}
    }
