...
\begin{frame}[label=thealgebra]{The algebra}
	\begin{itemize}
		...
		\item Normal form: similar to a DNF: terms may contain ANDs, NOTs, and XBefores.
	\end{itemize}
\end{frame}
...
\begin{frame}[label=expressorder]{How to express order?}
	\begin{itemize}
		...
		\end{itemize}
		\item The exclusive before expresses that one variable comes before another \hyperlink{xbeforedefs}{\beamergotobutton{definition}}
...
\begin{frame}[noframenumbering,label=tasks]{Tasks schedule}
	\begin{center}
		\scriptsize
